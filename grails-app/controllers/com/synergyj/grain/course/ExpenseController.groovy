...
class ExpenseController {
  ...
  static allowedMethods = [save: "POST", update: "POST", delete: "POST", addToScheduledCourse: "POST"]

  def addToScheduledCourse = {
    def expense = new Expense(params)
    def scheduledCourse = ScheduledCourse.get(params.long('scheduledCourseId'))
