...
<body>
	...
	<div>
		...
		<div id="s2ui_main">
			<div id="s2ui_content">
				<script type="text/javascript" src="${resource(dir:'js/jquery',file:'jquery.jgrowl.js',plugin:'spring-security-ui')}"></script>
        <script type="text/javascript" src="${resource(dir:'js/jquery',file:'jquery.checkbox.js',plugin:'spring-security-ui')}"></script>
        <script type="text/javascript" src="${resource(dir:'js/jquery',file:'jquery.date_input.js',plugin:'spring-security-ui')}"></script>
        <script type="text/javascript" src="${resource(dir:'js/jquery',file:'jquery.positionBy.js',plugin:'spring-security-ui')}"></script>
        <script type="text/javascript" src="${resource(dir:'js/jquery',file:'jquery.bgiframe.js',plugin:'spring-security-ui')}"></script>
        <script type="text/javascript" src="${resource(dir:'js/jquery',file:'jquery.jdMenu.js',plugin:'spring-security-ui')}"></script>
        <script type="text/javascript" src="${resource(dir:'js/jquery',file:'jquery.dataTables.min.js',plugin:'spring-security-ui')}"></script>
        <script type="text/javascript" src="${resource(dir:'js',file:'spring-security-ui.js',plugin:'spring-security-ui')}"></script>
				<g:layoutBody/>
			</div>
		</div>
