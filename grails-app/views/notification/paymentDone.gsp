<%@ page import="com.synergyj.grain.course.KindOfPayment" contentType="text/html"%>
                                          ...
                                          <table cellspacing="0" cellpadding="0" border="0" align="left" width="190">
                                            <tr>
                                              <td valign="top" style="padding-right: 20px;">
                                                ...
                                                ${grailsApplication.config.grails.serverURL+'/themes/mail/images/secure-payment.jpeg'}" alt="istockphoto" align="left" style="border-width: 3px; border-style: solid; border-color: #ffffff;" />
                                              </td>
                                            </tr>
                                          </table>
                                          <p style="font-size: 12px; line-height: 20px; font-weight: normal; color: #56667d; margin: 0; margin-bottom: 10px;">
                                            Hemos recibido y validado el pago correspondiente al curso que te has inscrito 
                                            recientemente con nosotros:
                                            <ul style="font-size: 12px; line-height: 20px; font-weight: normal; color: #56667d; margin: 0; margin-bottom: 10px; padding-left: 250px;">
                                  
                                            <li>Monto recibido: 
                                              <b>
                                                $ <g:formatNumber number="${payment?.amount ?: 0.00}" locale="MX" format="#,###.00"/>
                                              </b>
                                            </li>
                                            <li>Tipo de pago: 
                                              <b>
